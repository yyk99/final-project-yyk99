PINO_ETH0_VERSION = 1.0
PINO_ETH0_SITE = $(BR2_EXTERNAL_yyk99_extra_PATH)/package/pino_eth0/src
PINO_ETH0_SITE_METHOD = local
PINO_ETH0_LICENSE = MIT

# For kernel modules
#MYMODULE_MODULE_SUBDIRS = .
#MYMODULE_MODULE_MAKE_OPTS = KVERSION=$(LINUX_VERSION_PROBED)

define PINO_ETH0_BUILD_CMDS
	$(MAKE) $(TARGET_CONFIGURE_OPTS) -C $(@D) all
endef

define PINO_ETH0_INSTALL_TARGET_CMDS
