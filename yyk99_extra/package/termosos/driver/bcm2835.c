...
// milliseconds
udelay(microseconds);  // Microsecond delay (busy-wait)
mdelay(milliseconds);  // Millisecond delay (busy-wait)
*/
...
int bcm2835_i2c_begin(void)
{
    ...
    */
    i2c_byte_wait_us = (cdiv / BCM2835_CORE_CLK_HZ) * 1000000 * 9; // TODO: !!!
...
void bcm2835_i2c_setClockDivider(uint16_t divider)
{
    ...
    // 9 = Clocks per byte : 8 bits + ACK
    */
    i2c_byte_wait_us = (divider / BCM2835_CORE_CLK_HZ) * 1000000 * 9; // TODO:
}
...
/*     if (map == MAP_FAILED) */
/*         printk(KERN_ERR "bcm2835_init: %s mmap failed", msg); */
/*     return map; */
/* #endif */
/* } */
...
int bcm2835_init(void)
{
    ...
    /* On a Raspberry Pi, you might see something like:
       0x7e000000 0x3f000000 0x01000000
    */
    bcm2835_peripherals_base = 0x3f000000;
    bcm2835_peripherals_size = 0x01000000;
    pud_type_rpi4 = 1;
    bcm2835_peripherals = ioremap(bcm2835_peripherals_base, bcm2835_peripherals_size);
